...
module.exports = () => {
	...
	for (const portal of portals) createPortal(portal);

	log(`\nTHINGS TO DO`, "info");
	log(`************\n`, "info");
	log(`1. Run "npm install" to download dependencies`, "info");
	log(`2. Setup your Postgres and Mongo databases`, "info");
	log(`3. In your migration files (I.e. /src/servcer/migrations/), add additional columns to your tables`, "info");
	log(`4. Include these variables in your environment (I.e. nodemon.json): MONGODB_URI, DATABASE_URI and SESSION_SECRET`, "info");
	log(`5. Verify that your models and migrations are correctly formed`, "info");
	log(`6. Run "knex migrate:latest" to run your migrations`, "info");
	log(`7. Configure webpack if you'll be using a client interface`, "info");
	log(`8. Run "git init" if you want version management control`, "info");
	log(`9. Start the server with "npm start"`, "info");
};
