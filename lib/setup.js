...
module.exports = async function() {
	try {
		...
		log(`3. Include these variables in your environment: MONGODB_URI, DATABASE_URI and SESSION_SECRET`, "info");
		log(`4. Run "knex migrate:latest" to run your migrations`, "info");
